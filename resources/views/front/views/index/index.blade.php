...
<!-- end Content -->
<a href="#blocker" data-toggle="modal">Read full bio</a>
...
<div id="blocker" class="modal" style="text-align: center;">
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="text-align: center; background-image: url('../images/bokeh.jpg');">
            <div class="modal-header">
                <!--<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>-->
                <h4 class="modal-title" id="myModalLabel"><img class="" src="/own/bonysubservices.png"/></h4>
            </div>
            <div class='step1'>
