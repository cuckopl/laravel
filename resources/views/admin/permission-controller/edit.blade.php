...
<div class="modal fade laravel-dynamic-modal" id="userModal-new" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        {!! Form::Model($permission,['method'=>'PUT' , 'route'=>['updateAclRole',$permission->id],'files'=> true]) !!}
...
<script type="text/javascript">var modalRoute = '{{route('updateAclPremission',$permission->id)}}';</script>
