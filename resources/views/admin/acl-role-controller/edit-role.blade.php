...
<div class="modal fade laravel-dynamic-modal" id="userModal-new" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        {!! Form::Model($role,['method'=>'PUT' , 'route'=>['updateAclRole',$role->id],'files'=> true]) !!}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @include ('admin.partials.acl-form.acl-role',['submitButtonText'=>'Update'])
                @include('errors.list')
            </div>
...
<script type="text/javascript">var modalRoute = '{{route('updateAclRole',$role->id)}}';</script>
