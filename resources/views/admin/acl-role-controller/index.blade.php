        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <table class="table table-bordered" id="acl-role-table">
                        <tfoot>
                        <th></th>
                        <th></th>
                        <th></th>
...
<script>
    ...
    $('#acl-role-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{route('aclGetRoleTable')}}',
        columnDefs: [{
    ...
    $('#acl-role-table tfoot th').each(function () {
        var title = $('#acl-role-table thead th').eq($(this).index()).text();
        $(this).html('<input type="text" placeholder="Search ' + title + '" />');
    });

    // DataTable
    var table = $('#acl-role-table').DataTable();
