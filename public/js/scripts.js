...
$(document).ready(function () {
    var slides = $('.home-slider .slides  .item');
    var slideCount = slides.size() - 1;
    ...
    $('.home-slider .pagination  li').click(function () {

        $('.home-slider .pagination  li').each(function () {
            $(this).removeClass('selected');
        });
        showSlide = $(this).attr('slide') - 1;
    ...
    $('.dropdown-nav').click(function () {
        thisthis = $(this);
        if (thisthis.next('ul').css('display') == 'none') {
            thisthis.next('ul').show();
        } else {
            thisthis.next('ul').hide();
